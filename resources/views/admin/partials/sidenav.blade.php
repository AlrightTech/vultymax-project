            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive(@$data->menu_active, 3) }}">
                        <img src="{{ @$data->icon }}" class="menu-icon" />
                        <span class="menu-title text-semibold" style="color: #FFFFFF !important;">{{ __(@$data->title) }}</span>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive(@$menu->menu_active) }} ">
                                <a href="{{ route(@$menu->route_name, $submenuParams) }}" class="nav-link">
                                    ...
                                    <span class="menu-title text-semibold" style="color: #FFFFFF !important;">{{ __($menu->title) }}</span>
