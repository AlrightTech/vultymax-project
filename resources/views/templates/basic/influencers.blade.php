                    ...
                    <div class="d-flex justify-content-between dash-sidebar filter-sidebar p-xl-0 flex-wrap gap-4 shadow-none">
                        ...
                        <div class="w-100 search-widget">
                            <div class="input-group">
                                <input type="text" name="" class="form-control form--control mySearch searchh-hiring" placeholder="@lang('Search here')" value="{{ request()->search }}">
                                <button class="input-group-text bg--base border--base searchBtn border-0 px-3 text-white searchh-hiring1" type="button"><i class="fas fa-search"></i></button>
                            </div>
                        </div>
